...
<body>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel"
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item">
				<img
					src="C:\Users\nimit\Desktop\myws\ecomm\src\main\webapp\resources\img\c5.jpg"
					alt="Flower" align="center" width="300" height="300">
			</div>
			<div class="item">
				<img
	...
	<h1 align="center">
		...
		&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; <small>
			<b>[Indian first ethnic wear online shoping site]</b>
		</small>
	</h1>
	<br>
	<h1 align="left">
		...
		<mark>
			<a
				href=" C:\Users\nimit\Desktop\eclipsew1\ff\src\main\webapp\aboutus.jsp">
				(about us) </a>
		</mark>
	</h1>
	<font color="red"> <!--  
...
<div class="row">
  <div class="col-md-3"><h1  > &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;Male </h1> </div> 
  <div class="col-md-3"> <h1>Female </h1></div> 
  <div class="col-md-3"> <h1>kids </h1></div>
     <div > <h1>Tiny Tots  </h1> </div>
</div>
...
--> <br> <BR>
		...
		<h1>
			mens>> <a
				...
				<img
				src="C:\Users\nimit\Desktop\myws\ecomm\src\main\webapp\resources\img\c8.jpg"
				alt="" class="img-circle" height="300" width="300">
			</a> &nbsp; &nbsp; &nbsp; <img
				src="C:\Users\nimit\Desktop\myws\ecomm\src\main\webapp\resources\img\16.jpg"
				alt="" class="img-circle" height="300" width="300"> &nbsp;
			&nbsp; &nbsp; <img
				src="C:\Users\nimit\Desktop\myws\ecomm\src\main\webapp\resources\img\c14.jpg"
				alt="" class="img-circle" height="300" width="300"> <br>
			<br> womens>> <img
				src="C:\Users\nimit\Desktop\myws\ecomm\src\main\webapp\resources\img\c1.jpg"
				alt="" class="img-circle" height="300" width="300"> &nbsp;
			&nbsp; &nbsp; <img
